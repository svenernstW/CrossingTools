...
#' @param calculate.index Logical. If \code{TRUE}, calculate the index
#'  based on segregation (co)variances. This only works if covariance is TRUE, else will be ignored.
#' @param weigths a vector of length equal to the number of traits with values representing the desired weights
#'
