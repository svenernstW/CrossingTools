...
#'
#' @export
calculate_variances_RIL <- function(crosses, genetic.map, M, U, t, intensity,
  ...
  # t must be >= 1 (your old code used t<0; that was inconsistent)
  if (t <= 0) {
  ...
  # ---- Call C++ ----
  # IMPORTANT: assumes your C++ RIL functions now accept:
